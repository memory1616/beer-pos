  ...
  <header class="sticky top-0 bg-white/90 backdrop-blur border-b shadow-sm z-50 pb-safe">
    ...
    <div class="px-4 pb-2">
      <div class="flex items-center justify-between text-sm">
        ...
        <span class="text-gray-500">Phí vận chuyển: <span id="totalDeliveryFee" class="font-bold text-green-600">0</span> ₫</span>
      </div>
    </div>
  </header>
        ...
        <div class="delivery-card bg-white rounded-lg shadow p-3" data-lat="${c.lat}" data-lng="${c.lng}" data-name="${c.name}">
          <div class="flex justify-between items-start">
            ...
            <div class="text-right">
              ...
              <div class="text-sm font-bold text-green-600 delivery-fee">-</div>
            </div>
          </div>
          <div class="flex gap-2 mt-2">
            ...
            <button onclick="startDelivery(${c.lat}, ${c.lng}, ${c.id})"
                    class="flex-1 bg-green-500 text-white py-2 rounded-lg text-sm">
              🚀 Giao hàng
            </button>
          </div>
        </div>
