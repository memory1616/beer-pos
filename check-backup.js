...
const backups = [
  './backup/backup-2026-03-12-2000.db',
  './backup/backup-2026-03-12-2300.db',
  './backup/backup-2026-03-13-2300.db'
];
...
for (const backup of backups) {
  ...
  try {
    ...
    if (purchases.cnt > 0) {
      ...
      console.log('Recent purchases:', JSON.stringify(rows, null, 2));
    }
    db.close();
  } catch (e) {
